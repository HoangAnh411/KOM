...
- [ ] typecheck sạch; server unit xanh (**128 sau B.1a**, sẽ tăng tiếp ở P0.2/P0.3a); client 78 + shared 3 xanh; 19 e2e xanh trên port 3100/5174; `check:bundle` ≤ 500 KiB/chunk
