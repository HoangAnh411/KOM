...
export function MenuModal({ onClose }: { onClose: () => void }) {
  ...
  return <Modal title="Trình đơn" onClose={onClose} className="player-menu-modal" actions={<Button variant="ghost" onClick={onClose}>Đóng</Button>}>
    ...
    <Button variant="destructive" onClick={() => { onClose(); logout(); }}>Đăng xuất</Button>
  </Modal>;
}
